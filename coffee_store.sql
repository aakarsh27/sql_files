...
insert into products (name, price, coffee_origin) 
values ('Macchiato', 3.00, 'Columbia'), ('Cappuccino', 3.50, 'Costa Rica');

insert into products (name, price, coffee_origin)
values ('Americano', 3.00, 'Ethiopia'), ('Latte', 3.50, 'Guatemala');


update products
set coffee_origin = 'punjab'
where id = 1;
...
WHERE product_id = invalid_product_id;
